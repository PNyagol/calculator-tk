...
from logic import evaluate_expression, square, sqrt
...
class Calculator:
    def __init__(self):
        ...
        self.window.title("Nyagol's Calculator")
    ...
    def evaluate(self):
        self.total_expression += self.current_expression
        self.update_total_label()
        self.current_expression = evaluate_expression(self.total_expression)
        self.total_expression = ""
        self.update_label()
    ...
    def update_label(self):
        self.label.config(text=self.current_expression[:8])
